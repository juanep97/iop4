...
class RawFit(FitFileModel):
    ...
    imgbinning = models.CharField(max_length=3, null=True, help_text="String with the format _XBINNING_x_YBINNING_ for the image, as in 2x2.")
    ...
    def _repr_pretty_(self, p, cycle):
        if cycle:
            ...
            with p.group(4, f'<{self.__class__.__name__}(', ')>'):
                ...
                p.breakable()
                p.text(f"binning: {self.imgbinning},")
                p.breakable()
